...
const ImageInput: React.FC<ImageInputProps> = ({ label, imageValue, onImageChange, onClear, inputId, maxSize = 3 * 1024 * 1024 }) => {
  ...
  return (
    <div className="image-input-container" style={{ marginTop: '5px' }}>
      ...
      {imageValue && (
        <div className="cu-image-preview-card" style={{ margin: '8px 0', border: '1px solid #ddd', borderRadius: '4px', overflow: 'hidden', height: '50px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#eee' }}>
...
const LayerEditor: React.FC<LayerEditorProps> = ({
  ...
  return (
    <div className="cu-layer-editor-card" style={{ marginTop: '12px', padding: '8px', border: '1px solid #eee', borderRadius: '6px', background: '#fafafa' }}>
      ...
      <div className="cu-layer-offset-card" style={{ display: 'flex', gap: '8px', marginTop: '10px', background: 'white', padding: '4px 6px', borderRadius: '4px', border: '1px solid #eee', width: 'fit-content', alignItems: 'center' }}>
