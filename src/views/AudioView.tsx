...
const AudioView: React.FC = () => {
  ...
  return (
    <div className="view-container">
      ...
      <section style={{ marginBottom: '20px', padding: '12px', border: '1px solid #d7e0e7', borderRadius: '8px', background: '#fff' }}>
        ...
        <div style={{ padding: '10px', border: '1px solid #e3e8ee', borderRadius: '8px', background: '#fafbfc', marginBottom: '12px' }}>
        ...
        {showSoundTypes && (
          <div style={{ marginTop: '10px', display: 'flex', flexDirection: 'column', gap: '8px', maxHeight: '260px', overflowY: 'auto' }}>
            {eventTypes.map(eventName => {
              ...
              return (
                <div key={eventName} style={{ padding: '8px', border: '1px solid #e3e8ee', borderRadius: '6px', background: '#fafbfc' }}>
