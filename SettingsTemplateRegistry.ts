...
registerSettingsTemplate({
  ...
  sections: [
    ...
    },
    {
      ...
      label: 'Panels',
      controls: [
        { id: 'ui-panel-opacity', settingId: 'ui.panelOpacity' },
        { id: 'ui-panel-backdrop-blur', settingId: 'ui.panelBackdropBlur' },
        { id: 'ui-panel-background-color', settingId: 'ui.panelBackgroundColor' }
      ]
    },
    {
      id: 'ui-overlays',
      label: 'Overlays',
      controls: [
        { id: 'ui-overlay-backdrop-opacity', settingId: 'ui.overlayBackdropOpacity' },
        { id: 'ui-overlay-content-blur', settingId: 'ui.overlayContentBlur' }
      ]
    },
    {
      id: 'ui-style',
      ...
      controls: [
        { id: 'ui-button-style', settingId: 'ui.buttonStyle' },
        { id: 'ui-sidebar-style', settingId: 'ui.sidebarStyle' }
      ]
    },
    {
      id: 'ui-workspace',
      label: 'Workspace',
      controls: [
        { id: 'ui-app-bg-color', settingId: 'ui.appBackgroundColor' },
        { id: 'ui-toolbar-bg-color', settingId: 'ui.toolbarBackgroundColor' }
      ]
    }
  ]
});
