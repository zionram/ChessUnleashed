...
export type SettingsFieldType = 'select' | 'range' | 'color' | 'checkbox' | 'number';
...
registerSettingsField({
  ...
  type: 'range',
  category: 'ui',
  settingsPath: 'uiAppearance.panelOpacity',
  defaultValue: 100,
  min: 0,
  max: 100,
  step: 5
...
registerSettingsField({
  id: 'ui.panelBackdropBlur',
  label: 'Panel Backdrop Blur',
  type: 'range',
  category: 'ui',
  settingsPath: 'uiAppearance.panelBackdropBlur',
  defaultValue: 0,
  min: 0,
  max: 20,
  step: 1
...
registerSettingsField({
  id: 'ui.overlayBackdropOpacity',
  label: 'Overlay Backdrop Opacity',
  type: 'range',
  category: 'ui',
  settingsPath: 'uiAppearance.overlayBackdropOpacity',
  defaultValue: 20,
  min: 0,
  max: 80,
  step: 5
...
registerSettingsField({
  id: 'ui.overlayContentBlur',
  label: 'Overlay Blur',
  type: 'range',
  category: 'ui',
  settingsPath: 'uiAppearance.overlayContentBlur',
  defaultValue: 10,
  min: 0,
  max: 20,
  step: 1
...
registerSettingsField({
  ...
  type: 'select',
  category: 'ui',
  settingsPath: 'uiAppearance.buttonStyle',
...
registerSettingsField({
  ...
  type: 'select',
  category: 'ui',
  settingsPath: 'uiAppearance.sidebarStyle',
  defaultValue: 'flat',
  options: [
...
registerSettingsField({
  id: 'ui.panelBackgroundColor',
  label: 'Panel Background Color',
  type: 'color',
  category: 'ui',
  settingsPath: 'uiAppearance.panelBackgroundColor',
  defaultValue: '#ffffff'
});

registerSettingsField({
  id: 'ui.appBackgroundColor',
  label: 'App Background',
  type: 'color',
  category: 'ui',
  settingsPath: 'uiAppearance.appBackgroundColor',
  defaultValue: '#f5f5f5'
});

registerSettingsField({
  id: 'ui.toolbarBackgroundColor',
  label: 'Toolbar Background',
  type: 'color',
  category: 'ui',
  settingsPath: 'uiAppearance.toolbarBackgroundColor',
  defaultValue: '#2c3e50'
});
