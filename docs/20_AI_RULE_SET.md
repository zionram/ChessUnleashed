...
P13. Every response MUST include the originating Prompt ID in the DONE line.

Format:
DONE [C#.P-###]: <5–10 word summary>

Example:
DONE [C5.P-000]: AssetSpec portable paths wired into builder
